                    ...
                    <div className="flex flex-wrap -mx-4 justify-center">
                        <div className="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
                            ...
                            <ul className="h-0 invisible md:h-auto md:visible overflow-hidden">
                                ...
                                <li>
                                    <Link to="/promo" className="hover:underline py-1 block">
                                        Promotion
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <div className="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
                            ...
                            <ul className="h-0 invisible md:h-auto md:visible overflow-hidden">
                                <li>
                                    <Link to="/abouut" className="hover:underline py-1 block">
                                        About
                                    </Link>
                                </li>
                                <li>
                        ...
                        <div className="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
                            ...
                            <ul className="h-0 invisible md:h-auto md:visible overflow-hidden">
                                ...
                                <li>
                                    <Link to="/devs" className="hover:underline py-1 block">
                                        For Developer
                                    </Link>
                                </li>
                            </ul>
