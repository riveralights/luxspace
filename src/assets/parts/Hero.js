...
import ImageSection from "assets/images/image-section-1.png";
            ...
            <div className="w-full inset-0 md:relative md:w-1/2">
              ...
              <div className="absolute w-full h-full">
                ...
                ></iframe>
                    ...
                    <img src={ImageSection} alt="hero 1" className="absolute inset-0 md:relative w-full h-full object-cover object-center" />
                </div>
            </div>
        </section>
    );
